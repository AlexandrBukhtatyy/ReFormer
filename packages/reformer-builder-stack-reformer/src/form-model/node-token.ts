 ...
 * «какой узел под курсором». Тот же довод и тот же исход, что у `plugins/base/preview/runtime/mock`:
 ...
 *
 * @module @reformer/builder-stack-reformer/form-model/node-token
 */
