 ...
 * `config/state` и `kits/registry`, в v2 будет сервис плагина `plugins/kits/registry/`). Поэтому
 ...
 *
 * @module @reformer/builder-stack-reformer/catalog/__fixtures__/builtin-catalog
 */
