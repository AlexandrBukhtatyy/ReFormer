 ...
 *
 * Снимок (`plugins/reformer/codegen/golden.test.ts`) печатает модуль встроенными целями, поэтому состав
 ...
 *
 * @module @reformer/builder-stack-reformer/codegen/templates.test
 */
