 ...
 * на строго более сильные: `plugins/reformer/codegen/golden.test.ts` держит ПОБАЙТОВЫЙ снимок каждого
 ...
 *
 * @module @reformer/builder-stack-reformer/codegen/emit.test
 */
