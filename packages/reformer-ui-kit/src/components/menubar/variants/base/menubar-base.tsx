...
// Дословный порт shadcn/ui (new-york-v4) menubar. Правки только: unified `radix-ui`
// (MenubarPrimitive), `@/lib/utils`, снят 'use client'. data-slot уже в апстриме на каждой части.
// Radix-overlay compound: Root/Menu/Trigger/Content/Item/CheckboxItem/RadioItem/Label/Separator/
// Shortcut/Group/Portal/RadioGroup/Sub/SubTrigger/SubContent. Content уходит в Portal.
