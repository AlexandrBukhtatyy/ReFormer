...
- Эталонные сценарии: [react-playground/src/pages/examples/](../../../../projects/react-playground/src/pages/examples/) (формы регистрации, multi-step с FormWizard, JSON-renderer).
