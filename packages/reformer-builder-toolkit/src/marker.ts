 ...
 *
 * @module @reformer/builder-toolkit/marker
 */
 ...
 *
 * `form.schema.json` (прежде `renderer.schema.json`) — тот случай, ради которого проверка
 * и появилась: JSON комментариев не знает, и маркер первой строкой делал файл неразбираемым.
 * Ломалось от этого ВСЁ, что его
