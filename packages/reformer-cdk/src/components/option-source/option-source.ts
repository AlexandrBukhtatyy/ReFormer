/**
 * Чистая (React-free) логика асинхронного источника опций списочных полей.
 *
 * Общее ядро Select / SelectMulti из `@reformer/ui-kit` и headless `useAutocomplete`
 * (`@reformer/cdk/autocomplete`). Стратегии загрузки, слияние страниц и клиентская
 * фильтрация юнит-тестируемы без DOM.
 *
 * @module cdk/option-source
 */
...
export interface ResourceItem<T> {
  ...
  value: T;
  /** Опциональное имя группы — варианты с одинаковым `group` выводятся одной группой списка. */
  group?: string;
...
/** Конфигурация асинхронного источника опций списочного поля. */
