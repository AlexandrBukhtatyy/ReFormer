  ...
  return (
    <>
      <Menubar className="h-7 gap-0.5 border-0 bg-transparent p-0 shadow-none">
        ...
        <MenubarMenu>
          <MenubarTrigger className={TRIGGER}>Справка</MenubarTrigger>
          <MenubarContent align="start">
            <MenubarItem onClick={() => setHelp('shortcuts')}>Горячие клавиши</MenubarItem>
            <MenubarItem onClick={() => setHelp('about')}>О программе</MenubarItem>
          </MenubarContent>
        </MenubarMenu>
      </Menubar>
