 ...
 * (`host/source`), но плагин видит платформу только через `@reformer/builder-plugin-api`, а источника там нет и не должно
 ...
 *
 * @module plugins/reformer/ai/knowledge/project-source
 */
