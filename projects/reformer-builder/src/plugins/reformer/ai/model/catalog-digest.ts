 ...
 * границе источника (`@/plugins/reformer/core/catalog`). Он намеренно у́же множества имён, которые ПРОХОДЯТ
...
import { isCompoundPart, partNamesOf } from '@/plugins/reformer/core/catalog';
import { makeNodeFor } from '@/plugins/reformer/core/catalog';
