 ...
 *
 * @module plugins/reformer/ai/tools/move-node
 */

import { moveNode } from '@/plugins/reformer/core/form-model';
import { kindOf } from '@/plugins/reformer/core/form-model';
import { isPrefix } from '@/plugins/reformer/core/form-model';
