 ...
 *
 * `labelOf`/`componentOf`/`modelOf` живут в `@/plugins/reformer/core/form-model` и отвечают на те же
...
import { componentOf, labelOf, modelOf } from '@/plugins/reformer/core/form-model';
