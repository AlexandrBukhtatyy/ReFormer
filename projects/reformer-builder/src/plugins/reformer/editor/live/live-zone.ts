 ...
 * Причина та же, по которой отдельно живёт {@link '../schematic/schematic-zone'}: правило проверяется
 ...
 *
 * Схематичный вид выводит ось из `className` (`orientationOf` из `@/plugins/reformer/core/form-model`),
 ...
 *
 * @module plugins/reformer/editor/live/live-zone
 */
