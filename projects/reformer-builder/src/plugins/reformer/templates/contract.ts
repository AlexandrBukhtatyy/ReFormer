 ...
 *
 * @module plugins/reformer/templates/contract
 */
 ...
 * отдельно: место фикстуры — предметное знание `@reformer/builder-stack-reformer/form-fixture`, а не запись в шаблоне.
 *
