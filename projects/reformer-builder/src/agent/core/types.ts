 ...
 *
 * Единственное осознанное повышение за всю историю: пакетные аргументы (`nodes[]`, `refs[]`,
 * `props{}`) прибавили около трёхсот символов КАЖДОМУ запросу, но убрали из эталонной задачи
 * одиннадцать обращений к модели — а каждое обращение несёт весь контекст целиком. Размен
 * выгоден примерно на два порядка.
 */
export const TOOL_SURFACE_BUDGET = 7686;
