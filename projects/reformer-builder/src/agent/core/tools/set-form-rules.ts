 ...
 *
 * Единственный write-инструмент, который правит НЕ схему. Правила — сайдкар (`model/rules`):
 ...
 *
 * @module reformer-builder/agent/core/tools/set-form-rules
 */

import { findCycle } from '@reformer/mcp/dist/core/utils/graph.js';
import { collectModelPaths } from '../../../model/query';
import { similarNames } from '../suggest';
import { emptyRules, type FormRules } from '../../../model/rules';
import { fail, ok, type AgentTool, type ToolOutcome } from '../types';
