 ...
 * write-инструменты, и сам обеспечивает узлу селектор (`model/selectors`). Ровно этого условия и
 ...
 *
 * @module reformer-builder/agent/core/tools/set-render-rules
 */

import { collectSchemaSelectors } from '@reformer/renderer-json';
import { ensureSelector } from '../../../model/selectors';
import {
  emptyRules,
  RENDER_RULE_KINDS,
  type FormRules,
