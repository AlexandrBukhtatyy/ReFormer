 ...
 * платформа.
 *
 * Вклады в меню и точка расширения живут в пакете `@reformer/builder-plugin-api`; здесь — сборка
 * дерева меню, сортировка корней и проверка неизвестных путей.
 *
