 ...
 *
 * **Что сделано иначе, чем в v1 (первой версии билдера (история git), `src/io/opfs.ts`):** плоский каталог
...
import { basename, dirname, normalizePath } from '@reformer/builder-plugin-api/internal';
