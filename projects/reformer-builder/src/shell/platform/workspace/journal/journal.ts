...
export interface RestoreOptions {
   ...
   *
   * Host не знает их словаря — он принадлежит провайдеру модели, то есть плагину стека.
   * Поэтому проигрывание модельных записей требует applier'а от вызывающего; без него журнал
   * отказывает, а не делает вид, что восстановил.
   */
