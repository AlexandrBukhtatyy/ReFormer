...
import { createCreditApplicationForm } from '@/components/forms/createCreditApplicationForm';
...
import { ContactInfoForm } from '@/components/steps/ContactInfoForm';
import { EmploymentForm } from '@/components/steps/EmploymentForm';
import { AdditionalInfoForm } from '@/components/steps/AdditionalInfoForm';
import { ConfirmationForm } from '@/components/steps/ConfirmationForm';
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {hasDraft && !draftLoaded && (
        <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg flex items-center justify-between" data-testid="draft-banner">
          <div>
      ...
      <div className="mt-4 text-center text-sm text-muted-foreground">
        <div>Step {currentStep} of {totalSteps} • {Math.round((currentStep / totalSteps) * 100)}% complete</div>
