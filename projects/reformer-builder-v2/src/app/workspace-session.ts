...
import type { EventBus } from '../host/primitives/event';
import type { ExtensionRegistry } from '../host/primitives/extension-point';
import { makeResourceId, type ResourceId } from '../host/primitives/resource';
import type { Source } from '../host/source/types';
import type { ValidationOrchestrator } from '../host/validation/orchestrator';
import { createResourceTreeStore, type ResourceTreeStore } from '../host/ui/resource-tree';
import { createResourceOperations, type ResourceOperations } from '../host/workspace/resource-ops';
import type { WorkspaceStatusSnapshot, WorkspaceStatusSource } from '../host/ui/status';
import {
  createDocumentTabsStore,
  type DocumentTabsStore,
  type TabsWorkspace,
} from '../host/ui/tabs';
import type { WhenContextStore } from '../host/ui/when-context-store';
import type { DiagnosticsSink, Workspace } from '../host/workspace/workspace';
import { createJournal, type Journal } from '../host/workspace/journal/journal';
import { createDivergenceWatch } from '../host/workspace/merge/divergence';
import type { DivergenceWatch } from '../host/workspace/merge/divergence';
import { createWorkspace } from '../host/workspace/workspace';
