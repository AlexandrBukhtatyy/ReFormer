...
import type { Diagnostic } from '../host/diagnostics/types';
...
import { isModelDocument } from '../host/workspace/model/model-document';
import { DocumentModelPoint } from '../host/workspace/model/provider';
import { createLinesProvider, setLineText } from '../host/workspace/model/testing';
