 ...
 * `plugins/**` не видит `@/host` — это правило слоёв, и обходить его тестом нельзя.
...
import { whenContext } from '../host/primitives/when-context';
import { createI18nService } from '../host/services/i18n/i18n';
import { EditorArea } from '../host/ui/EditorArea';
import { createDocumentTabsStore, type TabsWorkspace } from '../host/ui/tabs';
...
import { createDocument, type Document } from '../host/workspace/document';
import type { SaveResult, WorkspaceChange } from '../host/workspace/workspace';
