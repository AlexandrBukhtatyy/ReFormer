...
import { isTextMediaType, type ResourceId } from '../host/primitives/resource';
import type { CommandRegistry } from '../host/primitives/command';
import type { RootI18nService } from '../host/services/i18n/i18n';
import type { WhenContextStore } from '../host/ui/when-context-store';
import { actionTargets, flattenTree } from '../host/ui/resource-tree';
import type { ExtensionReader } from '../host/ui/usePanels';
