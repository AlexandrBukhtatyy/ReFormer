 ...
 *
 * @module plugins/editor-monaco/MonacoEditor
 */
...
import type { MonacoFocusRegistry } from './focus';
import type { MonacoDocument, MonacoHost, Translate } from './host';
import { shouldStopPropagation } from './input';
import { languageFor, modelPathFor } from './language';
import { hasNodeTargets, planMarkers, type MarkerDraft } from './markers';
import { ensureMonaco } from './monaco-setup';
import { indexNodeRanges, type NodeLocation } from './node-ranges';
import { createSyncState, reduceSync, type SyncEvent, type SyncState } from './sync';
import { monacoThemeFor, useDarkTheme } from './theme';
import type { ViewStateRegistry } from './view-state';
