 ...
 *
 * @module plugins/ai/tools/remove-node
 */

import { removeNode } from '@/lib/form-model/mutate';
...
import { componentOf, isResolved, labelOf, refToPath, resolveRef } from '../model/node-ref';
