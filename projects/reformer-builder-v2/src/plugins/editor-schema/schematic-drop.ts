 ...
 *
 * Надстройка над {@link './drag'}, а не его замена. Три «плоских» зоны (`before`, `after`,
 ...
 * Здесь так нельзя: словарь операций обязан быть обратимым по шагам ({@link './ops'}), а
 ...
 *
 * @module plugins/editor-schema/schematic-drop
 */
...
import { planDrop, wrapperLeftBehind, type DragPayload, type DropPosition } from './drag';
import { indexNodes } from './node-index';
import { batchOp, flipOp, groupOp, insertOp, moveOp, slotPositionOf, unwrapOp } from './ops';
