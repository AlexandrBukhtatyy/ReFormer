 ...
 * {@link './placement'} и {@link '../canvas/canvas-tree'}: правила перетаскивания — предметные, у них
 ...
 * которого больше нет (см. шапку {@link '../model/ops'}). Поэтому решение принимается заранее, по
 ...
 *
 * @module plugins/editor-schema/editing/drag
 */
 ...
 *
 * Публична ради второго планировщика: схематичный вид ({@link '../schematic/schematic-drop'}) оставляет за
