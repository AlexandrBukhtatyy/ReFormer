 ...
 * о цели. Причина та же, по которой отдельно живёт {@link './drag'}: правило «куда метится
 ...
 *
 * Дерево строк даёт три положения ({@link './drag'}), потому что у строки нет левого края.
 ...
 *
 * @module plugins/editor-schema/schematic-zone
 */
