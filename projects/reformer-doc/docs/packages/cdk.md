...
Такой подход даёт полную свободу дизайна и доступность (a11y) из коробки. Если готовые стилизованные версии нужны сразу — используйте [@reformer/ui-kit](../ui-kit/overview), который построен поверх cdk.
