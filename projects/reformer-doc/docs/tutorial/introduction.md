...
Tutorial source code on [GitHub](https://github.com/AleexandrBukhtatyy/ReFormer/tree/main/projects/reformer-tutorial)
:::
...
7. **Working with Data** — Loading, transformation, validation and saving
