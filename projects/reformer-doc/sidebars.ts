...
const sidebars: SidebarsConfig = {
  ...
  apiSidebar: [
    ...
    // Variables category убрана — typedoc генерирует variables только внутри
    // @reformer/namespaces/.../variables/, а не на top-level api/variables/,
    // поэтому category пустая → "neither subitem nor link" error.
  ],
};
