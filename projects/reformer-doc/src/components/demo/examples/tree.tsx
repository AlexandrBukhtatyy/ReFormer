...
/**
 * Tree — НЕ form-control: у него нет ни `value`, ни `onChange`, ни статики `reformerAdapter`, поэтому
...
export const treeDocConfig: ComponentDocConfig = {
  ...
  description:
    'Плотное дерево строк файлового навигатора: уровни, треугольники, значки, метки. Источник — либо готовые узлы (nodes), либо ленивое чтение уровня (loadChildren); раскрытие, выделение и отмеченный набор дерево держит само, но у каждой оси есть управляемая пара. Виртуальный скролл включён по умолчанию. Tree — навигация, а не поле формы: у него нет value / onChange и статики reformerAdapter.',
  variants: [
    {
      id: 'static',
