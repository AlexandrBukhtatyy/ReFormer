 ...
 *
 * Прежний `slugify` вырезал кириллицу целиком, поэтому секция с чисто русским заголовком
 * получала пустой слаг и выпадала из разбора: её не было ни в поиске, ни в каталоге, ни по
 * URI. Молча — заголовок в документе есть, а секции нет. Затронуто 17 секций в пяти пакетах,
 * и у части файлов такой была ПЕРВАЯ секция, то есть терялась и шапка документа.
 */
